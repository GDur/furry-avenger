 ...
 * @author Radek
 */
public final class ColorizerUsingSearch {
    ...
    private void colorize(DeepRBM rbm) {
        ...
        try {
            ...
            Logger.getLogger(ColorizerUsingSearch.class.getName()).log(Level.SEVERE, null, ex);
        }
