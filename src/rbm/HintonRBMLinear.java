 ...
 * @author Radek
 */
public class HintonRBMLinear implements RBM {
   
    private static final Log LOG = LogFactory.getLog(HintonRBMLinear.class);
    ...
    public HintonRBMLinear(RBMSettings rbmSettings, DataProvider dataProvider) {
    ...
    public void train() {
        ...
        for(int epoch = 0; epoch < maxepoch; epoch++) {
            ...
            for(int batch = 0; batch < numbatches; batch++) {
                ...
                //System.out.println("epoch: " + epoch + " batch: " + batch + "errsum");
                ...
                FloatMatrix poshidstates = poshidprobs;
                ...
                vishidinc = vishidinc.mmul(momentum).add( (posprods.sub(negprods).div(numcases).sub(vishid.mmul(weightcost))).mmul(epsilonw / numcases) );
